...
template class mrs_lib::RHEIV<ball_filter::rheiv::n_states, ball_filter::rheiv::n_params>;
...
using namespace ball_filter::rheiv;
...
int main()
{
  std::string fname = "/home/matous/ball_workspace/src/ros_packages/ball_filter/data.csv";
  std::string plane_fname = "/home/matous/ball_workspace/src/ros_packages/ball_filter/plane.csv";
